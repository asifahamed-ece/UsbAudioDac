/* Core/Src/font8x8.h
 *
 * Classic public-domain 8x8 ASCII font, 95 glyphs ' ' (32) .. '~' (126).
 * Same table as the RescuePulse ST7735S reference build (font8x8_basic).
 *
 * Layout: ROW-major. Every glyph is 8 bytes; byte 0 is the TOP row and
 * byte 7 is the BOTTOM row. Within a row byte, BIT 7 (0x80) is the
 * LEFT-most pixel and bit 0 is the RIGHT-most pixel.
 *
 * IMPORTANT: include this header from exactly ONE firmware translation
 * unit (st7735.c) so `static const` emits one copy; host unit tests may
...
static const uint8_t font8x8[95][8] = {
    ...
    {0x0F, 0x06, 0x06, 0x06, 0x66, 0x66, 0x3C, 0x00}, /* 74 'J' */
