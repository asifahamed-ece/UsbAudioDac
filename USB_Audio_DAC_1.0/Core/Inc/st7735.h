...
/* Compact 5x7 text metrics used by ST7735_DrawString5x7 / ...Centered5x7.
 * Advance is 5 px of glyph + 1 px gap; there is no trailing gap, so a
 * string of n characters occupies n*ST7735_ADVANCE5X7 - 1 pixels. */
#define ST7735_GLYPH5X7_W   5
#define ST7735_GLYPH5X7_H   7
#define ST7735_ADVANCE5X7   6
